    ...
    <div class="min-h-screen">
        ...
        <section class="relative bg-[#073c2f] py-20">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">Master Your Golf Game in Singapore
                        </h1>
                        <p class="text-xl text-white mb-8">Professional golf instruction with certified coaches. From
                            beginners to advanced players, we help you achieve your golfing goals with personalised
                            training programs.</p>
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border h-11 rounded-md px-8 border-white text-white hover:bg-white hover:text-[#073c2f] bg-transparent"
                                href="coaches.html">Meet Our Coaches</a>
                        </div>
                    </div>
                    <div class="relative">
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose True Golf Singapore?</h2>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
                        <div class="flex flex-col space-y-1.5 p-6">
                            ...
                            <div class="text-2xl font-semibold leading-none tracking-tight">Certified Professionals
                            </div>
                        </div>
                        <div class="p-6 pt-0">
                    ...
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
                        <div class="flex flex-col space-y-1.5 p-6">
                            ...
                            <div class="text-2xl font-semibold leading-none tracking-tight">Personalised Training</div>
                        </div>
                        <div class="p-6 pt-0">
                    ...
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
                        <div class="flex flex-col space-y-1.5 p-6">
                            ...
                            <div class="text-2xl font-semibold leading-none tracking-tight">Modern Facilities</div>
                        </div>
                        <div class="p-6 pt-0">
        ...
        <section class="py-20 bg-[#073c2f] text-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl md:text-4xl font-bold mb-4">Ready to Improve Your Golf Game?</h2>
                <p class="text-xl mb-8 opacity-90">Book your first lesson today and start your journey to better golf.
                </p>
